...
### Changed
- Apply GCOV mask layer so that invalid and partially focused pixels are set to NoData in the output of `make_rgb_geotiff()`.

## [0.3.0]

### Removed
- Removed overviews from the output geotiff generated by `make_rgb_geotiff()`.
